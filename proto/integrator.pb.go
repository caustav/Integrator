...
/*
Package com_integrator_grpc is a generated protocol buffer package.
...
type DataType struct {
	...
	Type    DataType_Type `protobuf:"varint,5,opt,name=type,enum=com.integrator.grpc.DataType_Type" json:"type,omitempty"`
}
...
func (m *ExecuteResponse) GetComponent() *Component {
	if m != nil {
		return m.Component
	}
	return nil
...
func init() {
	proto.RegisterType((*Module)(nil), "com.integrator.grpc.Module")
	proto.RegisterType((*RegisterResponse)(nil), "com.integrator.grpc.RegisterResponse")
	proto.RegisterType((*StartRequest)(nil), "com.integrator.grpc.StartRequest")
	proto.RegisterType((*StartResponse)(nil), "com.integrator.grpc.StartResponse")
	proto.RegisterType((*Component)(nil), "com.integrator.grpc.Component")
	proto.RegisterType((*DataType)(nil), "com.integrator.grpc.DataType")
	proto.RegisterType((*SaveChainRequest)(nil), "com.integrator.grpc.SaveChainRequest")
	proto.RegisterType((*SaveChainResponse)(nil), "com.integrator.grpc.SaveChainResponse")
	proto.RegisterType((*ExecuteRequest)(nil), "com.integrator.grpc.ExecuteRequest")
	proto.RegisterType((*ExecuteResponse)(nil), "com.integrator.grpc.ExecuteResponse")
	proto.RegisterEnum("com.integrator.grpc.DataType_Type", DataType_Type_name, DataType_Type_value)
}
...
func (c *integratorClient) Register(ctx context.Context, in *Module, opts ...grpc.CallOption) (*RegisterResponse, error) {
	...
	err := grpc.Invoke(ctx, "/com.integrator.grpc.Integrator/Register", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *integratorClient) Start(ctx context.Context, in *StartRequest, opts ...grpc.CallOption) (*StartResponse, error) {
	...
	err := grpc.Invoke(ctx, "/com.integrator.grpc.Integrator/Start", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *integratorClient) SaveChain(ctx context.Context, in *SaveChainRequest, opts ...grpc.CallOption) (*SaveChainResponse, error) {
	...
	err := grpc.Invoke(ctx, "/com.integrator.grpc.Integrator/SaveChain", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Integrator_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.integrator.grpc.Integrator/Register",
	}
...
func _Integrator_Start_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.integrator.grpc.Integrator/Start",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Integrator_SaveChain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.integrator.grpc.Integrator/SaveChain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Integrator_serviceDesc = grpc.ServiceDesc{
	ServiceName: "com.integrator.grpc.Integrator",
...
func (c *integratorModuleClient) Execute(ctx context.Context, in *ExecuteRequest, opts ...grpc.CallOption) (*ExecuteResponse, error) {
	...
	err := grpc.Invoke(ctx, "/com.integrator.grpc.IntegratorModule/Execute", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _IntegratorModule_Execute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.integrator.grpc.IntegratorModule/Execute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _IntegratorModule_serviceDesc = grpc.ServiceDesc{
	ServiceName: "com.integrator.grpc.IntegratorModule",
...
var fileDescriptor0 = []byte{
	...
	,
}
